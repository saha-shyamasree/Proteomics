...
def findPeptidesStartStop(prt, pepObj):
	...
	aggregations = {
	'MS-GF:PepQValue': lambda x: x.mean(),
	...
	start_stop_pre_post[['PepQValue','Modifications','Charge','PSM Count']] = pepObjUnique.reindex(start_stop_pre_post.index,level=0)[['MS-GF:PepQValue','Modifications','Charge','Spectrum ID']]
